...
source: SRD
name: Acid Burrower 2
creature: Acid Burrower 2
...
feats:
  ...
  - name: Spit Acid - Action
    desc: Make an attack against all targets in front of the Burrower within Close range. Targets the Burrower succeeds against take 7 (2d6) physical damage and must mark an Armor Slot without receiving its benefits (they can still use armor to reduce the damage). If they can’t mark an Armor Slot, they must mark an additional HP and you gain a Fear.
  - name: Acid Bath - Reaction
    desc: When the Burrower takes Severe damage, all creatures within Close range take 5 (1d10) physical damage. This splash covers the ground within Very Close range with blood, and all creatures other than the Burrower who move through it take 3 (1d6) physical damage.
hp: "8"
stats:
  - 14
  - 8/15
